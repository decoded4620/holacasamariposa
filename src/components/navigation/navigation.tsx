      ...
      <Toolbar className={styles.toolbar}>
        ...
        >
          <h2 className={styles.navheader}>
            {width > props.mobileViewMaxWidth && (props.text)}
            {width <= props.mobileViewMaxWidth && (props.shortText)}
          </h2>
        </Box>
        ...
        {width <= props.mobileViewMaxWidth ? (
          <Hamburger
            clickHandler={() => onMenuToggleClicked()}
            className={
              props.darkMode ? styles.hamburgerDark : styles.hamburgerLight
            }
          />
        ) : null}
      </Toolbar>
